...
N 500 -450 500 -300 {lab=Vout}
N 500 -300 600 -300 {lab=Vout}
N 500 -260 600 -260 {lab=VICM}
N 500 -260 500 -210 {lab=VICM}
N 500 -450 860 -450 {lab=Vout}
N 380 -70 500 -70 {lab=GND}
N 380 -110 380 -70 {lab=GND}
N 350 -110 380 -110 {lab=GND}
...
C {ngspice_probe.sym} 500 -310 0 1 {name=r1}
...
C {devices/code_shown.sym} 10 -510 0 0 {name=NGSPICE1 only_toplevel=true 
value="
.option wnflag=1
.option savecurrents
.temp 27
...
.endc
"}
C {vsource.sym} 500 -180 0 0 {name=V1 value="PULSE(0 0.825 1p 50n 50n 750n 1.5u 2)" savecurrent=false}
C {vsource.sym} 500 -100 0 0 {name=V3 value=0 savecurrent=false}
